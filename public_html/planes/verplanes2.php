...
<body>
  <div class="container-scroller" <div class="main-panel">
            ...
            <div class="col-md-6 grid-margin stretch-card" style="width: auto; height: 700px;">
              <div class="card" style="background: url('../assets/images/planes/fondoplanes.jpg') center center / cover no-repeat; border-radius: 20px; position: relative;">
                <div class="card-body text-dark">
                  ...
                  <img src="../assets/images/planes/inter.gif" alt="Descripción de la imagen" class="card-img-top" style="border-radius: 20px 20px 0 0; width: 80%; height: 50%; display: block; margin-left: auto; margin-right: auto;">
