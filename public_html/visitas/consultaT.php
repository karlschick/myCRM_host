              ...
              <form class="forms-sample">
                ...
                <div class="form-group">
                  ...
                  <div class="form-button mt-5">
                    <button id="submit" type="submit" formmethod="post" formaction="../visitas/tablasVisitasT.php" class="btn btn-primary btn-lg">Volver a todas las visitas</button>
                    <td>
                      <a href="actualizarVisitaT.php?id=<?php echo "$id" ?>" class="btn btn-info btn-lg">Actualizar</a>
                    </td>
                  </div>
