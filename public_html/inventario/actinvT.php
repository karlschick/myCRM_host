        ...
        <div class="card">
          <div class="card-body">
            ...
            <form action="../planes/actplan.php" method="POST">
              ...
              <p></p>
              <input type="submit" class="btn btn-primary btn-lg" value="Actualizar" formmethod="post" formaction=updateinventarioT.php>
              <input type="submit" class="btn btn-danger btn-lg" value="Cancelar" formaction=tablasinventarioT.php>
            </form>
