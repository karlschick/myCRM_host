...
<body>
  ...
  <div class="main-panel">
    <div class="content-wrapper"> <!-- ESTO ES LO QUE TENEMOS QUE MODIFICAR -->
      ...
      <div class="card-body">
        <a href="tablasinventarioT.php" class="btn btn-primary " role="button" aria-pressed="true">Volver a activos</a>
        <?php
    ...
    ';
        ...
        ?>
            <tr>
              ...
              <th>
              <th><a href="activarpT.php?id=<?php echo $row['idProducto'] ?>" class="btn btn-danger">Volver a activar</a></th>
              </th>
            </tr>
        <?php
          }
