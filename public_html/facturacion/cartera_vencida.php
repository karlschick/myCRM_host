...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="page-header">
      <h1 style="font-size: 32px;">CARTERA VENCIDA</h1>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <?php
        // Consultar facturas vencidas o en mora
        $sql = "
            SELECT 
                c.idCliente,
                c.nombreCliente,
            ...
            WHERE c.estadoCliente='Activo' 
              AND (f.estadoFactura='Vencida' OR f.estadoFactura='Mora')
        ...
        if ($resultado && $resultado->num_rows > 0) {
            ...
            echo "<tr><td colspan='7' class='text-center'>No hay facturas vencidas.</td></tr>";
        }

        echo '</tbody>
              </table>';

        echo "<h4 class='mt-4'>Total Cartera Vencida: <strong style='color:red;'>$".number_format($totalVencido, 0, ',', '.')."</strong></h4>";
        ?>
