...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="page-header">
      <h1 style="font-size: 32px;">CARTERA POR COBRAR</h1>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <?php
        // Consultar la suma de todas las facturas pendientes
        $sql = "
            SELECT 
                c.idCliente,
                c.nombreCliente,
            ...
            WHERE c.estadoCliente='Activo' AND f.estadoFactura='Pendiente'
        ...
        if ($resultado && $resultado->num_rows > 0) {
            ...
            echo "<tr><td colspan='6' class='text-center'>No hay facturas pendientes.</td></tr>";
        }

        echo '</tbody>
              </table>';

        echo "<h4 class='mt-4'>Total Cartera por Cobrar: <strong style='color:red;'>$".number_format($totalPendiente, 0, ',', '.')."</strong></h4>";
        ?>
